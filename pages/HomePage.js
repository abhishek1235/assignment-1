...
class HomePage extends ElementHelper{
    ...
    async getFirstColumnSortedAsc(){
        ...
        // return this.tableComputerNameElements.getText().then((list) => {
        //     return list.sort();
        // })
    }
    ...
    //     return this.pageHeader.getText().then((text) => {
    //         this.totalComputerCount = text.split(' ')[0];
    //     })
    // }
    ...
    async getTotalComputerCount(){
        ...
        // console.log(this.totalComputerCount);
